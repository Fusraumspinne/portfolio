...
import SpotifyPlayingState from "@/components/SpotifyPlayingState";
...
const Skeleton = ({ id }: { id?: number | null }) => (
  <div
    className={cn("flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br", id === 3 ? "" : "border border-white/[0.2]")}>
    {id === 4 ? (
    ...
    {id === 2 ? (
      <div className=" overflow-hidden w-full relative">
        ...
        <Image
          ...
          width={1000}
          height={1000}
          className="h-full w-full ms-[2rem] mt-[3rem]"
        />
      </div>
    ) : (
      <div></div>
    ...
    {id === 5 ? (
      <div className=" overflow-hidden w-full relative">
        ...
        <Image
          ...
          width={1000}
          height={1000}
          className="h-full w-full ms-[0.5rem] mt-[0.3rem]"
        />
      </div>
    ) : (
      <div></div>
...
const items = [
  {
    ...
    description:
      "From this portfolio, my first big game to online-shops and chat-apps",
  ...
  },
  {
    ...
    description:
      "I am working on a Mafia Game and a reworked version of my AI in Python",
