...
const cards = [
  ...
  {
    description: "Druglord's Legacy successor",
    title: "Silenzio",
    src: "/images/Silenzio.png",
    ctaText: "Expand",
    ctaLink: "https://github.com/Fusraumspinne/Gang-Tycoon",
    content: () => {
      return (
        <p>
  ...
  {
    description: "Mincreaft hosting service",
    title: "Hosting Service",
    src: "/images/HostingService.png",
    ctaText: "Expand",
    ctaLink: "https://github.com/Fusraumspinne/hosting-service",
    content: () => {
      return (
        <p>
          A Minecraft hosting service currently under development. I aimed to build a secure, user-friendly, and efficient platform with features like email-based password recovery, multilingual support, and other administrative tools. The project was a collaboration with a friend but is paused for now because he lost access to his Linux server.
        </p>
      );
    },
  },
  {
    description: "A gambling website",
    title: "Flopper Gambling",
    src: "/images/FlopperGambling.png",
    ctaText: "Expand",
    ctaLink: "https://github.com/Fusraumspinne/flopper-gambling",
    content: () => {
      return (
        <p>
          To pass the time at school we played games on our iPads, but since gambling was disabled I decided to build my own. This site was created with a different approach—about 90% of the initial design and code was generated by AI. I experimented with “vibe coding” and learned which models work best for different tasks. It was fun but sometimes frustrating; the AI-produced design and code were often inconsistent, which showed me that AI is not yet capable of creating well-designed, maintainable code on its own. It proved most useful as an assistant for UI ideas and project structure.
        </p>
      );
    },
  },
